...
IO_USERNAME = os.environ['Adrie2']
IO_KEY = os.environ['aio_PiTG92mIChH7NL2PrSy7JkUTZ3We']
IO_URL = os.environ.get('io.adafruit.com/dashboards/testrasp', 'io.adafruit.com')
